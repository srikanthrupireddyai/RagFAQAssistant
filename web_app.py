...
- The answers provided are based on processed documentation and may not be
 current.
- Users should always refer to the official AWS documentation for
...
if __name__ == "__main__":
   ...
   print(f"\n{'=' * 60}")
   print("RAG FAQ Assistant Web Interface")
   print(f"{'=' * 60}")
   ...
   print("For authoritative information, refer to official AWS documentation.\n")
